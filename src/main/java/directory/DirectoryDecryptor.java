...
/**
 * Recursively walks a directory tree and submits decryption tasks
 * to a bounded thread pool. Each file is processed independently by a
 * DecryptWorker using AES‑GCM (NIO).
 *
 * Features:
 ...
 *
 * This class never performs decryption itself; it only coordinates
