...
/**
 * Recursively walks a directory and submits encryption tasks
 * to a thread pool. Each file is processed by an EncryptWorker thread.
 *
 * Features:
 ...
 *
 * This class never performs encryption itself. It only schedules
